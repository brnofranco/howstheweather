		...
		<div className="weather">
			...
			<section className="other-info">
				<div className="weather-content">
					<Card
						text="Temperatura máxima do dia"
						value={Math.round(JSON.stringify(weather['main']['temp_max']))}
						type="°"
					/>
					<Card
						text="Temperatura mínima do dia"
						value={Math.round(JSON.stringify(weather['main']['temp_min']))}
						type="°"
					/>
